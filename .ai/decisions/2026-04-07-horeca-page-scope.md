...
This repository is not a generic company website. It targets HoReCa design directions, where visitors need to evaluate a visual approach and AI agents need implementation guidance quickly. Reusable design guidance needs a durable decision about what page types these designs should normally cover.

## Decision

Treat this repository as a HoReCa design catalog and cover each design direction through a practical set of public-facing sections.
